...
<table class="table table-bordered" width="100%" cellpadding="0" cellspacing="0" >
  <tr>
    ...
    function konTambah() {
            window.location = "input_alternatif.php?act=tambah";
    }
    </script>
...
$perhalaman=15;
$query_part ="SELECT a.id_alternatif, a.nik, a.alternatif, a.id_divisi, b.divisi
              FROM alternatif as a, divisi as b
	    	  WHERE a.id_divisi=b.id_divisi AND
              (a.alternatif LIKE '%$txtcari%'OR b.divisi LIKE '%$txtcari%')";
...
FROM alternatif as a, divisi as b
WHERE a.id_divisi=b.id_divisi AND
(a.alternatif LIKE '%$txtcari%'OR b.divisi LIKE '%$txtcari%') ORDER BY a.nik ASC LIMIT $halamannya, $perhalaman";
...
function konfirmasi<?php echo $dataquery[0]; ?>() {
  ...
  <tr>
    ...
    <td align="center">
    <a href="input_alternatif.php?act=edit&id=<?php echo"$dataquery[0]"; ?>">
