    ...
    <body">
        ...
        <div class="sidebar-menu">
            <ul>
                ...
                <li>
                    <a style="text-decoration:none" href="data_divisi.php" class="active"><span class="las la-clipboard-list"></span><span>Data Divisi</span></a>
                </li>
                <li>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td width="77%"><input class="btn btn-primary" name="" type="submit" value="Cari" class="tombol"/></td>
  </tr>
</table>
<br>
</form>
<table class="table table-bordered" width="100%" cellpadding="0" cellspacing="0" >
  <tr>
  	<th width="5%">No.</th>
    <th width="90%">Divisi</th>
	<script type="text/javascript">
    function konTambah() {
            window.location = "input_divisi.php?act=tambah";
    }
    </script>
...
$perhalaman=15;
$query_part ="SELECT id_divisi, divisi FROM divisi
	    	  WHERE (divisi LIKE '%$txtcari%')";
...
$nomor=$halamannya;
$query="SELECT id_divisi, divisi FROM divisi
	    WHERE (divisi LIKE '%$txtcari%') ORDER BY id_divisi ASC LIMIT $halamannya, $perhalaman" ;
...
function konfirmasi<?php echo $dataquery[0]; ?>() {
	...
	if (answer){
		window.location = "aksi_divisi.php?act=hapus&id=<?php echo"$dataquery[0]"; ?>";
	}
}
</script>
  <tr>
    ...
    <td align="center">
    <a href="input_divisi.php?act=edit&id=<?php echo"$dataquery[0]"; ?>">
